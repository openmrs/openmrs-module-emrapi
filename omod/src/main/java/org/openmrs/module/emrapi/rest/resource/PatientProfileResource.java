...
@Resource(name = RestConstants.VERSION_1
        + "/patientprofile", supportedClass = PatientProfile.class, supportedOpenmrsVersions = { "2.2 - 9.*" })
public class PatientProfileResource extends DelegatingCrudResource<PatientProfile> {
	...
	public Object create(SimpleObject propertiesToCreate, RequestContext context) throws ResponseException {
		...
		PatientResource1_8 patientResource1_9 = (PatientResource1_8) Context.getService(RestService.class)
	...
	private Relationship updateRelationship(final Map<String, Object> relationshipJson) {
		...
		RelationshipResource1_8 relationshipResource = (RelationshipResource1_8) Context.getService(RestService.class)
		        .getResourceBySupportedClass(Relationship.class);
		...
		relationshipResource.setConvertedProperties(relationship, relationshipJson,
		    relationshipResource.getUpdatableProperties(), true);
		
		RelationshipType updatedRelationshipType = getRelationshipType(
	...
	private RelationshipType getRelationshipType(Map<String, Object> relationshipTypeJson) {
		...
		RelationShipTypeResource1_8 relationshipResource = (RelationShipTypeResource1_8) Context
		        .getService(RestService.class).getResourceBySupportedClass(RelationshipType.class);
	...
	public Object update(String uuid, SimpleObject propertiesToUpdate, RequestContext context) throws ResponseException {
		...
		PatientResource1_8 patientResource1_9 = (PatientResource1_8) Context.getService(RestService.class)
		        .getResourceBySupportedClass(Patient.class);
		Patient patient = patientResource1_9.getPatientForUpdate(uuid,
		    (Map<String, Object>) propertiesToUpdate.get("patient"));
