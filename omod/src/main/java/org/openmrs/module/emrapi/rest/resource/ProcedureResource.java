...
public class ProcedureResource extends DataDelegatingCrudResource<Procedure> {
	...
	protected PageableResult doSearch(RequestContext context) throws ResponseException {
		...
		return new AlreadyPaged<>(context, Context.getService(ProcedureService.class).getProceduresByPatient(patient,
		    includeAll, firstResult, maxResults), hasMore, totalCount);
	}
