...
public class InpatientRequestConverter extends SimpleBeanConverter<InpatientRequest> {
    ...
    /**
     * @return a representation of each property that matches the given representation, except when
     * requesting the default representation, in which case all properties are ref except for visit which is default
     */
    @Override
