...
public class MostRecentAdmissionRequestVisitDataEvaluator implements VisitDataEvaluator {
	...
	@Override
	public EvaluatedVisitData evaluate(VisitDataDefinition visitDataDefinition, EvaluationContext evaluationContext)
		...
		query.select("encounter.visit.id, encounter").from(Encounter.class, "encounter").innerJoin("encounter.obs", "dispo")
		        ...
		        .whereEqual("dispo.voided", false).whereEqual("encounter.voided", false)
	...
	private Location getToLocation(Encounter encounter, DispositionService dispositionService,
