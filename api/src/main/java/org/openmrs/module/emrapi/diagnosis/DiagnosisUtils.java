...
public class DiagnosisUtils {
	...
	public static Diagnosis convert(org.openmrs.Diagnosis coreDiagnosis) {
		...
		if (coded != null) {
			diagnosis
			        .setDiagnosis(new CodedOrFreeTextAnswer(coded.getCoded(), coded.getSpecificName(), coded.getNonCoded()));
		}
		diagnosis.setCertainty(
		    coreDiagnosis.getCertainty() == ConditionVerificationStatus.CONFIRMED ? Diagnosis.Certainty.CONFIRMED
