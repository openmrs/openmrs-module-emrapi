...
public class EmrEncounterServiceImpl extends BaseOpenmrsService implements EmrEncounterService {
    ...
    private List<EncounterUpdatePostProcessor> encounterUpdatePostProcessors;
    ...
    public void onStartup() {
        try {
            ...
            encounterUpdatePostProcessors = Context.getRegisteredComponents(EncounterUpdatePostProcessor.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public EncounterTransaction save(EncounterTransaction encounterTransaction) {
        ...
        if(encounterUpdatePostProcessors != null){
            for(EncounterUpdatePostProcessor encounterPostProcessor: encounterUpdatePostProcessors){
                encounterPostProcessor.forSave(encounter, encounterTransaction);
            }
        }
    ...
    private void postProcessEncounter(Encounter encounter,EncounterTransaction encounterTransaction){
        if(encounterUpdatePostProcessors != null){
            for(EncounterUpdatePostProcessor encounterPostProcessor: encounterUpdatePostProcessors){
                encounterPostProcessor.forRead(encounter, encounterTransaction);
            }
        }
    }
