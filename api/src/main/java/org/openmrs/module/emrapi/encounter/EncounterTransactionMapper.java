...
public class EncounterTransactionMapper {
	...
	public EncounterTransactionMapper(EncounterObservationsMapper encounterObservationsMapper,
	...
	@Autowired(required = false)
	public EncounterTransactionMapper(EncounterObservationsMapper encounterObservationsMapper,
	    EncounterProviderMapper encounterProviderMapper, OrderMapper orderMapper) {
	...
	public EncounterTransaction map(Encounter encounter, Boolean includeAll) {
		...
		encounterTransaction
		        .setEncounterTypeUuid(encounter.getEncounterType() != null ? encounter.getEncounterType().getUuid() : null);
