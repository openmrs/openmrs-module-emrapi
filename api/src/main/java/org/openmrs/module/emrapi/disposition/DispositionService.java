...
public interface DispositionService {
	 ...
	 * like admission location, transfer location, and date of death) for recording a Disposition
	 * concept set
	 *
	 ...
	 * any where careSettingType = null) 3) if visit.isAdmitted() = false, then return only those whore
	 * careSettingTypes contains OUTPATIENT (or any where careSettingType = null)
	 */
