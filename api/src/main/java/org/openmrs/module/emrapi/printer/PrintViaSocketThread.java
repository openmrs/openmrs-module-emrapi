 ...
 */
public class PrintViaSocketThread implements Runnable {
    ...
    public PrintViaSocketThread(String data, Printer printer, String encoding) {
    ...
    public PrintViaSocketThread(String data, Printer printer, String encoding, Integer wait) {
        this.printer = printer;
        this.data = data;
        this.encoding = encoding;
        this.wait = wait;
    ...
    private void printViaSocket() throws UnableToPrintViaSocketException {
