...
public class DiagnosisMetadata extends ConceptSetDescriptor {
	...
	public DiagnosisMetadata(ConceptService conceptService, ConceptSource emrConceptSource) {
		setup(conceptService, EmrApiConstants.EMR_CONCEPT_SOURCE_NAME,
		    ConceptSetDescriptorField.required("diagnosisSetConcept", EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CONCEPT_SET),
	...
	public Obs buildDiagnosisObsGroup(Diagnosis diagnosis) {
		...
		Concept certaintyAnswer = findAnswer(diagnosisCertaintyConcept,
		    diagnosis.getCertainty().getCodeInEmrConceptSource());
